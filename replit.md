...
- **Removed /learn page**: Deleted standalone learn page. Learning is now unified under `/academy` (My Mentor) and home page courses widget. Home page courses widget uses `/api/courses` (same DB as academy).
