      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 relative h-[600px] rounded-[2.5rem] overflow-hidden border border-slate-200 shadow-2xl group">
             <GeneratedImage 
               prompt="inside a massive modern ecommerce fulfillment center in USA, robots moving packages, high tech conveyor belts, bright clean industrial lighting, busy workers in blue vests, 8k photorealistic"
