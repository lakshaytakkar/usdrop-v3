...
export default function CompetitorStoreDetailPage() {
  ...
  const fetchStore = useCallback(async () => {
    ...
    try {
      ...
      const response = await apiFetch(`/api/admin/competitor-stores/${storeId}`, {
        credentials: 'include'
      })
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      const response = await apiFetch(`/api/admin/competitor-stores/${storeId}/products`, {
        credentials: 'include'
      })
  ...
  const confirmDelete = async () => {
    ...
    try {
      const response = await apiFetch(`/api/admin/competitor-stores/${store.id}`, {
        method: "DELETE",
        credentials: 'include'
      })
