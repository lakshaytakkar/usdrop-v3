...
import { Container, Section, Badge, GeneratedImage } from './ui';
...
const tools = [
  {
    ...
    badge: "HOT",
    badgeType: "hot",
    prompt: "grid of colorful social media ad thumbnails, facebook ads interface, clean ui"
  },
  {
    ...
    badge: "NEW",
    badgeType: "new",
    prompt: "ecommerce product list interface with sparkline sales charts, clean tables, blue accents"
  },
  {
    title: "Portfolio",
    description: "Receive up to 40 hand-picked curated products from our specialists every week.",
    badge: null,
    prompt: "grid of curated product cards with price tags, minimalist design, white background"
  },
  {
    title: "Competitor Research",
    description: "Make laser-targeted searches on millions of product listings to find out which stores sell.",
    badge: null,
    prompt: "search bar interface with dropdown filters and store results list, clean data visualization"
  },
  {
    title: "Magic AI",
    ...
    badge: "BETA",
    badgeType: "new",
    prompt: "artificial intelligence brain network visualization, connecting nodes, blue and white, tech abstract"
  },
  {
    title: "Chrome Extension",
    description: "Supercharge your product research with our Chrome Extension. Instantly analyze trends.",
    badge: null,
    prompt: "browser extension popup window showing product analytics graph, floating over a webpage"
  }
];
