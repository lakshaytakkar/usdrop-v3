    ...
    <div className="bg-white space-y-12 py-12" id="product-research">
      ...
      <Section className="py-0">
        <Container>
           ...
           <div className="bg-slate-50 border border-slate-200 rounded-[3rem] p-6 md:p-10 flex flex-col lg:flex-row gap-8 items-center overflow-hidden">
      ...
      <Section className="py-0">
        <Container>
           <div className="bg-slate-900 text-white rounded-[3rem] p-6 md:p-10 flex flex-col lg:flex-row-reverse gap-8 items-center overflow-hidden relative">
              {/* Abstract bg */}
