  ...
  return (
    <div className="flex flex-1 flex-col min-w-0 h-full overflow-hidden">
      <div className="flex items-center justify-between mb-1">
        <div>
          <h1 className="text-xl font-semibold leading-[1.35] tracking-tight text-foreground">Suppliers</h1>
          <p className="text-sm text-muted-foreground mt-1">Manage product suppliers</p>
        </div>
      </div>

      {!initialLoading && suppliers.length > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
          <div className="bg-card border rounded-lg p-4 shadow-[0px_1px_2px_0px_rgba(13,13,18,0.06)] dark:shadow-none">
            ...
            <div className="mt-1">
              <span className="text-2xl font-semibold">{suppliers.length.toLocaleString()}</span>
            </div>
            <div className="mt-2">
              <span className="text-xs text-muted-foreground">All registered suppliers</span>
            </div>
          </div>
          <div className="bg-card border rounded-lg p-4 shadow-[0px_1px_2px_0px_rgba(13,13,18,0.06)] dark:shadow-none">
            <div className="flex items-center justify-between">
            ...
            <div className="mt-1">
              <span className="text-2xl font-semibold">{suppliers.filter(s => s.verified).length.toLocaleString()}</span>
            </div>
            <div className="mt-2">
          ...
          <div className="bg-card border rounded-lg p-4 shadow-[0px_1px_2px_0px_rgba(13,13,18,0.06)] dark:shadow-none">
            ...
            <div className="mt-1">
              <span className="text-2xl font-semibold">{suppliers.length > 0 ? (suppliers.reduce((sum, s) => sum + s.rating, 0) / suppliers.length).toFixed(1) : '0'}</span>
            </div>
            <div className="mt-2">
              <span className="text-xs text-muted-foreground">Average supplier rating</span>
            </div>
          </div>
        </div>
      )}
