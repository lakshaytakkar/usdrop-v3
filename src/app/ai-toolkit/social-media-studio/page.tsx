...
import { SocialMediaStudio } from "@/components/ai-tools/social-media-studio"
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-2 p-4 md:p-6 bg-gray-50/50 min-h-0 relative">
          ...
          <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-purple-900 via-purple-950 to-pink-800 p-3 text-white h-[154px] flex-shrink-0">
            ...
            <div className="relative z-10 flex items-center gap-4 h-full">
              ...
              <div className="relative w-20 h-20 md:w-24 md:h-24 flex-shrink-0">
                <div className="relative w-full h-full rounded-xl overflow-hidden bg-white/10 backdrop-blur-sm border border-white/20">
                  <Image
                    src="/images/banner-thumbnails/social-media-studio.png"
              ...
              <div className="flex-1 min-w-0">
                <h2 className="text-2xl md:text-3xl font-bold leading-tight mb-2">USDrop Social Media Studio</h2>
                <p className="text-white/90 text-sm md:text-base leading-relaxed">
                  Create engaging captions, hashtags, and post text for your social media campaigns.
                </p>
              </div>
          ...
          <SocialMediaStudio />
          <OnboardingProgressOverlay pageName="Social Media Studio" />
        </div>
      </SidebarInset>
    </SidebarProvider>
  )
