...
export default function AdminPlansPage() {
  ...
  const handleFormSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      if (editingPlan) {
        response = await apiFetch(`/api/admin/plans/${editingPlan.id}`, {
          method: 'PATCH',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(requestBody),
        })
      } else {
        response = await apiFetch("/api/admin/plans", {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(requestBody),
        })
  ...
  const confirmDelete = async () => {
    ...
    try {
      const response = await apiFetch(`/api/admin/plans/${planToDelete.id}`, {
        method: "DELETE",
      })
