      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
           ...
           <div className="relative h-[550px] bg-slate-800 rounded-[2.5rem] border border-slate-700 shadow-2xl overflow-hidden group hover:border-blue-500/50 transition-colors">
              <GeneratedImage 
                prompt="futuristic spy software interface for ecommerce, dark mode dashboard, glowing red and green metrics, world map with data connections, matrix style visuals, high tech"
