                ...
                <div className="bg-slate-900 rounded-[2.5rem] p-6 md:p-8 text-white relative overflow-hidden shadow-2xl shadow-blue-900/20 group">
                   ...
                   <div className="relative z-10">
                      ...
                      <div className="space-y-8">
                         ...
                         <div className="pt-2">
                            <Button fullWidth size="lg" className="h-12 bg-white text-slate-900 hover:bg-slate-100 hover:scale-[1.02] active:scale-[0.98] font-bold border-none shadow-xl transition-all">
                               Start Selling Now
                            </Button>
