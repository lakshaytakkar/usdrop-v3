...
import { Container, Section, Button, GeneratedImage, Badge } from './ui';
...
const products: Product[] = [
  {
    ...
    growth: "250%",
    itemsSold: "43,000",
    prompt: "high tech baby monitor with camera and app interface, nursery setting, soft lighting, product photography, white background"
  },
  {
    id: "2",
    ...
    growth: "186%",
    itemsSold: "39,600",
    prompt: "luxury korean skincare set bottles 10 step routine, pastel colors, water splash, podium, beauty product photography"
  },
  {
    id: "3",
    ...
    growth: "101%",
    itemsSold: "59,790",
    prompt: "sleek silver wireless noise cancelling headphones, floating, premium tech lighting, white background studio shot, 4k"
  },
  {
    id: "4",
    ...
    growth: "320%",
    itemsSold: "28,560",
    prompt: "boho style summer maxi dress floral print, hanging on rack, sunlight flare, bright lifestyle fashion photography"
  }
];
