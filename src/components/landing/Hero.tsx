...
import { Container, GeneratedImage } from './ui';
...
const demoProducts = [
  { id: 1, name: "Levitating Moon Lamp", profit: "$45.00", prompt: "levitating moon lamp floating above wood base, dark room, glowing warm light, product photography" },
  { id: 2, name: "Portable Neck Fan", profit: "$22.50", prompt: "portable neck fan worn by model, summer vibes, cyan color, lifestyle photography" },
  { id: 3, name: "Smart Galaxy Projector", profit: "$38.00", prompt: "galaxy projector in bedroom, nebula clouds on ceiling, purple and blue lighting" },
];
...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative h-[calc(100vh-5rem)] min-h-[600px] max-h-[850px] flex items-center bg-white text-slate-900 border-b border-slate-100 overflow-hidden pt-[108px]">
      ...
      <Container className="w-full h-full relative z-10">
        <div className="h-full flex flex-col lg:flex-row items-center justify-between gap-3 lg:gap-8 relative">
          ...
          <div className="w-full lg:w-auto lg:max-w-2xl flex flex-col justify-center lg:pl-0 pt-[54px]">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl font-medium tracking-tight leading-[1.1] mb-8 font-sans">
              ...
              <Image
                ...
                width={64}
                height={64}
                className="inline-block align-middle ml-1 w-[0.9em] h-[0.9em] object-contain"
              />
              {' '}All-in-One
              <br/>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8 pt-6 border-t border-slate-200">
              <div>
                <div className="text-lg font-semibold text-slate-900 mb-1">Product Research</div>
                <div className="text-sm text-slate-600 leading-relaxed">50M+ products with real-time analytics</div>
              </div>
              <div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-slate-300 rounded-lg shadow-sm hover:shadow-md transition-all hover:border-slate-400 w-fit">
          ...
          <div className="shrink-0 flex justify-center items-center relative w-full lg:w-auto lg:pr-0 lg:ml-auto">
            ...
            <div className="relative">
              ...
              {/* Active Card */}
              <div 
                className={`relative w-[260px] h-[400px] md:w-[280px] md:h-[430px] bg-white rounded-2xl shadow-2xl border border-slate-100 z-20 overflow-hidden transition-all duration-300 ${
                direction === 'left' ? '-translate-x-20 -rotate-12 opacity-0' : 
                direction === 'right' ? 'translate-x-20 rotate-12 opacity-0' : ''
              }`}
            >
                <div className="h-3/5 bg-slate-50 relative">
                  <GeneratedImage prompt={product.prompt} className="w-full h-full object-cover" />
                  <div className="absolute top-4 right-4 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-xs font-bold text-green-600 border border-green-100">
              ...
              <div className="h-2/5 p-5 flex flex-col justify-between">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button 
                    ...
                    className="h-10 rounded-lg border-2 border-slate-200 text-slate-400 hover:border-red-500 hover:text-red-500 hover:bg-red-50 flex items-center justify-center transition-all"
                  >
                    <X className="w-5 h-5" />
                  </button>
                  <button 
                    onClick={() => handleSwipe('right')}
                    className="h-10 rounded-lg bg-blue-600 text-white hover:bg-blue-700 shadow-lg shadow-blue-600/20 flex items-center justify-center transition-all"
                  >
