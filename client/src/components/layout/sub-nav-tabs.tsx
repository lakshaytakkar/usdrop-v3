        ...
        {activeGroup.items.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "flex items-center gap-1.5 px-3.5 py-2.5 ds-label whitespace-nowrap transition-all border-b-2",
                isActive
                  ? "ds-text-primary border-blue-600 font-semibold"
                  : "ds-text-muted border-transparent hover:text-gray-600 hover:border-gray-200",
                isLocked && "opacity-50"
              )}
            >
