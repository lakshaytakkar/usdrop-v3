          ...
          <MotionStagger staggerDelay={0.15}>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative z-10">
              ...
              >
                ...
                >
                  ...
                  <div className="w-12 h-12 relative">
                    <img src="/images/landing/automation-order.png" alt="Order Icon" className="object-contain opacity-80" />
                  </div>
                </motion.div>
              ...
              >
                ...
                >
                  <div className="w-12 h-12 relative">
                    <img src="/images/landing/automation-pack.png" alt="Pack Icon" className="object-contain opacity-80" />
                  </div>
                </motion.div>
              ...
              >
                ...
                >
                  <div className="w-12 h-12 relative">
                    <img src="/images/landing/automation-customer.png" alt="Customer Icon" className="object-contain opacity-80" />
                  </div>
                </motion.div>
           ...
           <div className="bg-slate-50 rounded-[2.5rem] p-6 md:p-8 border border-slate-200 hover:border-blue-200 transition-colors">
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-100 flex items-center gap-4">
                 <div className="w-16 h-16 bg-slate-100 rounded-lg shrink-0 overflow-hidden relative">
                    <img src="/images/landing/automation-blender.png" alt="Product" className="object-cover" />
                 </div>
