...
- **1-on-1 Mentorship Marketing Page** (`/1on1-mentorship`): Public landing page for upselling mentorship. Inspired by Ali Lokhandwala's structure. Sections: Hero with CTA, animated stats counter bar, pain points (3 cards with AI-generated images), success stories (4 testimonial cards), step-by-step guide (6 steps), who-is-this-for (4 personas), journey timeline (6 phases with alternating layout), DIY vs Mentorship comparison table, why mentorship delivers (3 cards), meet your mentor (Mr. Supran bio with portrait), bonuses section (4 bonus cards with values), FAQ accordion (8 items), final CTA section. Pricing intentionally hidden. All AI-generated images in `public/images/mentorship/`. Files: `client/src/pages/(marketing)/mentorship/page.tsx`.
