    ...
    <Section className="bg-white border-t border-slate-100 overflow-hidden">
      <Container>
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6">Trusted by Top Sellers</h2>
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          {/* Main Card */}
          <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-xl p-8 md:p-12 relative z-10 min-h-[400px] flex flex-col md:flex-row items-center gap-10 md:gap-16 transition-opacity duration-300"
            ...
            <div className="flex-1 text-center md:text-left space-y-6">
               ...
               <blockquote className="text-2xl md:text-3xl font-medium text-slate-900 leading-relaxed font-display">
                 "{current.quote}"
               </blockquote>
               
               <div>
                 <div className="font-bold text-xl text-slate-900">{current.name}</div>
