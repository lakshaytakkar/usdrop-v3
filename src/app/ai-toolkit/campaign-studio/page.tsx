    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 md:p-6 bg-gray-50/50">
          ...
          <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-purple-900 via-violet-950 to-purple-800 p-4 md:p-5 text-white h-[140px]">
            ...
            <div className="relative z-10 flex items-center gap-4 h-full">
              ...
              <div className="flex-1 min-w-0">
                <h2 className="text-2xl md:text-3xl font-bold mb-1.5 leading-tight">USDrop Campaign Planner</h2>
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="text-lg font-semibold mb-4">Campaign Planner</h3>
              <p className="text-muted-foreground mb-6">
                Plan and organize your Meta advertising campaigns. This feature is coming soon with full campaign management capabilities.
              </p>
