...
export function LoginForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Determine redirect based on user type and plan
      // First check if there's a redirectedFrom parameter
      ...
      // Build metadata-like object from API response for redirect logic
      const metadata: UserMetadata = {
        ...
        internalRole: null, // Not needed for redirect logic
        isExternal: !data.isInternal,
        plan: data.plan || 'free',
        planName: data.planName || 'Free',
        status: 'active',
        onboardingCompleted: !data.requiresOnboarding,
