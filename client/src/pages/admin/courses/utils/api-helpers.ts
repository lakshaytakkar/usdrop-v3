...
export async function saveModuleToAPI(courseId: string, module: Module, isNew: boolean): Promise<Module> {
  ...
  if (isNew) {
    const response = await apiFetch(`/api/admin/courses/${courseId}/modules`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
    ...
    const response = await apiFetch(`/api/admin/courses/${courseId}/modules/${module.id}`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
      },
...
export async function deleteModuleFromAPI(courseId: string, moduleId: string): Promise<void> {
  const response = await apiFetch(`/api/admin/courses/${courseId}/modules/${moduleId}`, {
    method: 'DELETE',
  })
...
export async function saveChapterToAPI(
  ...
  if (isNew) {
    const response = await apiFetch(`/api/admin/courses/${courseId}/modules/${moduleId}/chapters`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
    ...
    const response = await apiFetch(`/api/admin/courses/${courseId}/modules/${moduleId}/chapters/${chapter.id}`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
      },
...
export async function deleteChapterFromAPI(courseId: string, moduleId: string, chapterId: string): Promise<void> {
  const response = await apiFetch(`/api/admin/courses/${courseId}/modules/${moduleId}/chapters/${chapterId}`, {
    method: 'DELETE',
  })
