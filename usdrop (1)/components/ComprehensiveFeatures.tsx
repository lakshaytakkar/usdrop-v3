...
import { Container, Section, GeneratedImage, Button } from './ui';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 grid-rows-auto gap-6 h-auto">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-2 row-span-2 bg-slate-50 border border-slate-200 rounded-[2rem] overflow-hidden relative group hover:shadow-2xl transition-all duration-500 cursor-pointer">
             <div className="absolute inset-0">
                <GeneratedImage 
                   prompt="grid of trendy winning ecommerce products, smartwatches, beauty products, gadgets, high quality commercial photography, white background, soft lighting"
          ...
          <div className="col-span-1 md:col-span-1 row-span-2 bg-white border border-slate-200 rounded-[2rem] p-6 flex flex-col justify-between hover:border-blue-300 hover:shadow-xl transition-all duration-300 group cursor-pointer">
             ...
             <div className="mt-6 aspect-[3/4] rounded-2xl overflow-hidden relative bg-slate-100 shadow-inner">
                <GeneratedImage 
                   prompt="fashion model wearing streetwear, urban setting, cinematic lighting, photorealistic portrait, 8k"
                   className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                />
                <div className="absolute bottom-3 right-3 bg-white/95 backdrop-blur px-3 py-1 rounded-full text-[10px] font-bold tracking-wide border border-slate-200 uppercase">
                   AI Generated
                </div>
             </div>
          </div>
          ...
          <div className="col-span-1 md:col-span-2 bg-slate-900 rounded-[2rem] p-8 md:p-10 flex items-center justify-between relative overflow-hidden group cursor-pointer">
             ...
             <div className="absolute right-0 top-0 bottom-0 w-3/5 opacity-20 group-hover:opacity-30 transition-opacity mask-image-gradient">
                <GeneratedImage 
                   prompt="abstract educational 3d icons, books, graduation cap, light bulb, floating in dark space, neon blue light, cinematic"
          ...
          {/* Item 6: Global (Wide) */}
          <div className="col-span-1 md:col-span-2 bg-surface border border-slate-200 rounded-[2rem] p-8 md:p-10 relative overflow-hidden group hover:border-blue-300 transition-all cursor-pointer">
