      ...
      <Container>
        ...
        <div className="bg-blue-600 rounded-3xl p-8 md:p-10 text-center text-white mb-12 relative overflow-hidden">
           ...
           <div className="relative z-10 max-w-2xl mx-auto space-y-6">
              <h2 className="text-2xl md:text-3xl font-bold">Try USDrop with a 7-day trial</h2>
        ...
        <div className="py-6 flex items-center justify-between text-xs text-slate-400 font-medium">
