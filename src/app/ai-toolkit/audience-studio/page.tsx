    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 md:p-6 bg-gray-50/50">
          ...
          <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-green-900 via-emerald-950 to-green-800 p-4 md:p-5 text-white h-[140px]">
            ...
            <div className="relative z-10 flex items-center gap-4 h-full">
              ...
              <div className="relative w-[120px] h-[110px] md:w-[140px] md:h-[130px] flex-shrink-0 bg-transparent">
                <Image
                  src="/audience-studio-mascot.png"
                  alt="3D mascot with analytics chart"
                  fill
              ...
              <div className="flex-1 min-w-0">
                <h2 className="text-2xl md:text-3xl font-bold mb-1.5 leading-tight">USDrop Audience Analyzer</h2>
                <p className="text-white/85 text-xs md:text-sm leading-relaxed">
                  Define and analyze your target audience segments. Get insights on demographics, 
                  interests, and behaviors to optimize your marketing campaigns.
                </p>
              </div>
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="text-lg font-semibold mb-4">Audience Analyzer</h3>
              <p className="text-muted-foreground mb-6">
                Define and analyze your target audience segments. This feature is coming soon with full audience insights.
              </p>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input placeholder="e.g., Age, Gender, Location" />
                </div>
                <div>
                  <label className="text-sm font-medium mb-2 block">Interests</label>
                  <Input placeholder="e.g., Fitness, Technology" />
                </div>
                <Button disabled className="w-full">
                  Analyze Audience (Coming Soon)
                </Button>
              </div>
            </CardContent>
          </Card>
