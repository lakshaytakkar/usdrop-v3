    ...
    <Section id="features" className="bg-slate-50 border-y border-slate-200">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-[350px_250px_250px] gap-4">
          ...
          <div className="md:col-span-2 md:row-span-2 bg-white rounded-[2.5rem] p-6 md:p-8 border border-slate-200 shadow-sm relative overflow-hidden group hover:shadow-2xl transition-all duration-500">
             <div className="absolute top-10 right-10 z-10 p-4 bg-white rounded-2xl shadow-lg border border-slate-100 hidden md:block">
          ...
          <div className="md:col-span-1 md:row-span-2 bg-slate-900 rounded-[2.5rem] p-6 border border-slate-800 relative overflow-hidden group">
          ...
          <div className="md:col-span-1 md:row-span-1 bg-blue-600 rounded-[2.5rem] p-6 text-white relative overflow-hidden group hover:bg-blue-700 transition-colors cursor-pointer">
          ...
          <div className="md:col-span-1 md:row-span-1 bg-white rounded-[2.5rem] p-6 border border-slate-200 group hover:border-green-200 transition-colors">
