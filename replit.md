...
- **Feb 2026**: Added "Free Learning" section to Framework homepage after welcome banner. Shows 6 preview videos in list format with thumbnails (play button overlay), title, and duration. Videos cover: What is Dropshipping, Finding Winning Products, Shopify Store Setup, Facebook Ads, Product Pricing, Order Fulfillment.
